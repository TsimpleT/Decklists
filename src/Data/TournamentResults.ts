...
import { HZO_20250914, BJO_20250831, CQO_20250907, GZO_20250824, SFC_20250803, NOS_20251101 } from "./Decklists/China";
...
import { MORE_DECKLISTS } from "./Decklists/MoreDecklists";

type TournamentAbbrName = "REQ" | "RMW" | "TNF" | "SFC" | "RLT" | "MCW" | "RFC" | "LUX" | "AEG" | "RLL" | "GZO" | "BJO" | "CQO" | "HZO" | "RNR" | "TBB" | "NOS" | "RMX" | "SRL" | "BRO" | "CCS" | "SCG" | "PPG" | "XYZ";
...
const SET_NAMES: {[key in Meta]: string} = { "OGN": "Origins", "SFD": "Spiritforged" };
export function GET_SET_NAME(meta: Meta): string {
    return SET_NAMES[meta];
}
