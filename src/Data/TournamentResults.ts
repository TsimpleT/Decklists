...
import { HZO_20250914, BJO_20250831, CQO_20250907, GZO_20250824, SFC_20250803, NOS_20251101, CDO_20260124, FZO_20260117, DLO_20260131, NJO_20260207, SZO_20260321, SZO_20260516, XAO_20260523 } from "./Decklists/China";
...
import { RNR_20250927, RNR_20251011, RNR_20251018, RNR_20251025, RNR_20251108, RNR_20251115, RNR_20251130, RNR_20251220, RNR_20251227, RNR_20260104, RNR_20260114, RNR_20260120, RNR_20260214, RNR_20260306, RNR_20260318, RNR_20260328, RNR_20260403, RNR_20260404, RNR_20260410, RNR_20260411, RNR_20260429, RNR_20260509 } from "./Decklists/RunesAndRift";
...
import { REQ_20251206, REQ_20260221, REQ_20260228, REQ_20260418, REQ_20260425, REQ_20260516, RSS_20260418 } from "./Decklists/Officials";
import { PPG_20250315, PPG_20251212, PPG_20251213, PPG_20251214 } from "./Decklists/ProPlayGames";
import { NVA_20260207, NVA_20260503 } from "./Decklists/NovaRiftbound";
import { NRG_20260315, NRG_20260510 } from "./Decklists/NRG";
import { GSC_20260321 } from "./Decklists/Gamescon";
import { NZO_20260403 } from "./Decklists/Australia";
import { CCC_20260418, CCC_20260425, CCC_20260502, CCC_20260510 } from "./Decklists/ChinaCityChallengeWinners";
import { MIC_20260510 } from "./Decklists/Spain";
import { TTN_20260509 } from "./Decklists/TitanGames";

type TournamentAbbrName = "REQ" | "RMW" | "TNF" | "SFC" | "RLT" | "MCW" | "RFC" | "LUX" | "AEG" | "RLL" | "GZO" | "BJO" | "CQO" | "HZO" | "RNR" | "TBB" | "NOS" | "RMX" | "SRL" | "BRO" | "CCS" | "SCG" | "PPG" | "XYZ" | "FZO" | "CDO" | "DLO" | "NJO" | "NVA" | "NRG" | "GSC" | "SZO" | "NZO" | "RSS" | "CCC" | "MIC" | "TTN" | "XAO";
type TournamentTier = number; // 0 = Championship, 1 = Regional, 2 = Regional-ish, 3 = Local, 4 = "Small Local";

export const ALL_METAS = [ "OGN", "SFD", "SFD2", "UNL" ] as const;
...
const META_NAMES: {[key in Meta]: string} = { "OGN": "Origins", "SFD": "Spiritforged (pre-ban)", "SFD2": "Spiritforged (post-ban)", "UNL": "Unleashed" };
...
export const TOURNAMENT_RESULT_DICT: {[key in Meta]: TournamentResults[]} = {"OGN": [], "SFD": [], "SFD2": [], "UNL": []};
