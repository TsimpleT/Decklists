...
import { HZO_20250914, BJO_20250831, CQO_20250907, GZO_20250824, SFC_20250803, CNO_20251101, CDO_20260124, FZO_20260117, DLO_20260131, NJO_20260207, CNO_20260321, SZO_20260516, XAO_20260523, TJO_20260606, CSO_20260614, CNO_20260719 } from "./Decklists/China";
...
import { REQ_20251206, REQ_20260221, REQ_20260228, REQ_20260418, REQ_20260425, REQ_20260516, REQ_20260530, REQ_20260613, REQ_20260620, RSS_20260418 } from "./Decklists/Officials";
import { PPG_20250315, RSS_20250704, PPG_20250705, PPG_20251212, PPG_20251213, PPG_20251214 } from "./Decklists/ProPlayGames";
import { NVA_20260207, NVA_20260503, NVA_20260726 } from "./Decklists/NovaRiftbound";
...
import { RSS_20260711 } from "./Decklists/Excalibur";
import { RSS_20260718, RSS_20260808 } from "./Decklists/OfficialOtherShowdowns";
...
type TournamentAbbrName = "REQ" | "RMW" | "TNF" | "SFC" | "RLT" | "MCW" | "RFC" | "LUX" | "AEG" | "RLL" | "GZO" | "BJO" | "CQO" | "HZO" | "RNR" | "TBB" | "CNO" | "RMX" | "SRL" | "BRO" | "CCS" | "SCG" | "PPG" | "XYZ" | "FZO" | "CDO" | "DLO" | "NJO" | "NVA" | "NRG" | "GSC" | "SZO" | "NZO" | "RSS" | "CCC" | "MIC" | "TTN" | "XAO" | "TJO" | "CSO" | "TES" | "EXC" | "NAT" | "RUL" | "GGH" | "CIR" | "RCS";
type TournamentTier = number; // 0 = Championship, 1 = Regional, 2 = Regional-ish, 3 = Local, 4 = "Small Local";

export const ALL_METAS = [ "OGN", "SFD", "SFD2", "UNL", "VEN" ] as const;
...
const META_NAMES: {[key in Meta]: string} = {
    "OGN": "Origins", "SFD": "Spiritforged (pre-ban)", "SFD2": "Spiritforged (post-ban)", "UNL": "Unleashed", "VEN": "Vendetta"
};
...
export const TOURNAMENT_RESULT_DICT: {[key in Meta]: TournamentResults[]} = {"OGN": [], "SFD": [], "SFD2": [], "UNL": [], "VEN": []};
